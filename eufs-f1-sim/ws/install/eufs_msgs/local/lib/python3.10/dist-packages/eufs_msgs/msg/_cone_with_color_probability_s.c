...
bool eufs_msgs__msg__cone_with_color_probability__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eufs_msgs.msg._cone_with_color_probability.ConeWithColorProbability", full_classname_dest, 67) == 0);
  }
  eufs_msgs__msg__ConeWithColorProbability * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of ConeWithColorProbability */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("eufs_msgs.msg._cone_with_color_probability");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConeWithColorProbability");
