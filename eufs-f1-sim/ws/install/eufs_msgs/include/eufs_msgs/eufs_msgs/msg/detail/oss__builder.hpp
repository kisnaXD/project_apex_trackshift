...
class Init_OSS_distance
{
public:
  explicit Init_OSS_distance(::eufs_msgs::msg::OSS & msg)
  : msg_(msg)
  {}
  ::eufs_msgs::msg::OSS distance(::eufs_msgs::msg::OSS::_distance_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_OSS_distance yaw_rate(::eufs_msgs::msg::OSS::_yaw_rate_type arg)
  {
    msg_.yaw_rate = std::move(arg);
    return Init_OSS_distance(msg_);
  }
