...
struct LapStats_
{
  ...
  using _oscillation_number_type =
    int64_t;
  _oscillation_number_type oscillation_number;
  ...
  Type & set__oscillation_number(
    const int64_t & _arg)
  {
    this->oscillation_number = _arg;
    return *this;
  }
  ...
  bool operator==(const LapStats_ & other) const
  {
    ...
    if (this->oscillation_number != other.oscillation_number) {
      return false;
    }
    return true;
  }
