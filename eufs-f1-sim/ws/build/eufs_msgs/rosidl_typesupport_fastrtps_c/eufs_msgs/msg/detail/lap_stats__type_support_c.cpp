  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: oscillation_number
  {
    cdr << ros_message->oscillation_number;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name oscillation_number
  {
    size_t item_size = sizeof(ros_message->oscillation_number);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, oscillation_number) +
      last_member_size
      ) == ret_val;
  }
