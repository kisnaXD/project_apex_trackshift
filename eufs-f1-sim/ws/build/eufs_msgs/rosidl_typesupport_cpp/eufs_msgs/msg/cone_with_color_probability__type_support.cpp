...
static const _ConeWithColorProbability_type_support_symbol_names_t _ConeWithColorProbability_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eufs_msgs, msg, ConeWithColorProbability)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eufs_msgs, msg, ConeWithColorProbability)),
  }
};
...
{
  return &::eufs_msgs::msg::rosidl_typesupport_cpp::ConeWithColorProbability_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, eufs_msgs, msg, ConeWithColorProbability)() {
  return get_message_type_support_handle<eufs_msgs::msg::ConeWithColorProbability>();
}
