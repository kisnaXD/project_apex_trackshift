...
bool eufs_msgs__msg__oss__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eufs_msgs.msg._oss.OSS", full_classname_dest, 22) == 0);
  }
  eufs_msgs__msg__OSS * ros_message = _ros_message;
  {  // header
  ...
  {  // v_y
    ...
    assert(PyFloat_Check(field));
    ros_message->v_y = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // yaw_rate
...
{
  /* NOTE(esteve): Call constructor of OSS */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("eufs_msgs.msg._oss");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OSS");
