...
bool eufs_msgs__msg__lap_stats__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // oscillation_number
    PyObject * field = PyObject_GetAttrString(_pymsg, "oscillation_number");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->oscillation_number = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
PyObject * eufs_msgs__msg__lap_stats__convert_to_py(void * raw_ros_message)
{
  ...
  {  // oscillation_number
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->oscillation_number);
    {
      int rc = PyObject_SetAttrString(_pymessage, "oscillation_number", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
