...
class LapStats(metaclass=Metaclass_LapStats):
    ...
    def __init__(self, **kwargs):
        ...
        self.oscillation_number = kwargs.get('oscillation_number', int())
    ...
    def __eq__(self, other):
        ...
        if self.max_deviation != other.max_deviation:
            return False
        if self.oscillation_number != other.oscillation_number:
            return False
        return True
    ...
    def avg_speed(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'avg_speed' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def speed_var(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'speed_var' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def max_slip(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'max_slip' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def max_lateral_accel(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'max_lateral_accel' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def normalized_deviation_mse(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'normalized_deviation_mse' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def deviation_var(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'deviation_var' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def max_deviation(self, value):
        if __debug__:
            ...
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'max_deviation' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._max_deviation = value

    @builtins.property
    def oscillation_number(self):
        """Message field 'oscillation_number'."""
        return self._oscillation_number

    @oscillation_number.setter
    def oscillation_number(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'oscillation_number' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'oscillation_number' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._oscillation_number = value
