...
class Init_LapStats_oscillation_number
{
public:
  explicit Init_LapStats_oscillation_number(::eufs_msgs::msg::LapStats & msg)
  : msg_(msg)
  {}
  ::eufs_msgs::msg::LapStats oscillation_number(::eufs_msgs::msg::LapStats::_oscillation_number_type arg)
  {
    msg_.oscillation_number = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_LapStats_oscillation_number max_deviation(::eufs_msgs::msg::LapStats::_max_deviation_type arg)
  {
    msg_.max_deviation = std::move(arg);
    return Init_LapStats_oscillation_number(msg_);
  }
