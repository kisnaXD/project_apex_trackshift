...
eufs_msgs__msg__LapStats__are_equal(const eufs_msgs__msg__LapStats * lhs, const eufs_msgs__msg__LapStats * rhs)
{
  ...
  // oscillation_number
  if (lhs->oscillation_number != rhs->oscillation_number) {
    return false;
  }
  return true;
}
  ...
  eufs_msgs__msg__LapStats * output)
{
  ...
  // oscillation_number
  output->oscillation_number = input->oscillation_number;
  return true;
}
  ...
  eufs_msgs__msg__LapStats__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    eufs_msgs__msg__LapStats * data =
      (eufs_msgs__msg__LapStats *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!eufs_msgs__msg__LapStats__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          eufs_msgs__msg__LapStats__fini(&output->data[i]);
        }
        return false;
      }
    }
