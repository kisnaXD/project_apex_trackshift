...
static rosidl_typesupport_introspection_c__MessageMember eufs_msgs__msg__OSS__rosidl_typesupport_introspection_c__OSS_message_member_array[6] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eufs_msgs__msg__OSS, distance),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
